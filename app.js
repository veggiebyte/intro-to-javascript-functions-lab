...
// function calculateGrade(numberGrade) {
//   if (numberGrade >= 90) {
//     return "A";
//   }
...
//   return firstThree + lastThree + totalLength;

//   }

// console.log('Exercise 11 Result:', createUsername("Samantha", "Green"));
// console.log('Exercise 11 Result:', createUsername("Cindy", "Stadterman"));
// console.log('Exercise 11 Result:', createUsername("Stehphen", "Morrissey"));
...
console.log('Exercise 12 Result:', numArgs(15000, 6595));
console.log('Exercise 12 Result:', numArgs(62, 85, 247));
